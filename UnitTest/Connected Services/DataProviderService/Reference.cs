...
namespace UnitTest.DataProviderService {
    ...
    public interface IDataProvider {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(UnitTest.DataProviderService.AutenticateFaultException), Action="http://tempuri.org/IDataProvider/AlterSummaryAutenticateFaultExceptionFault", Name="AutenticateFaultException", Namespace="http://schemas.datacontract.org/2004/07/CFAPService.Faults")]
        [System.ServiceModel.FaultContractAttribute(typeof(UnitTest.DataProviderService.DbException), Action="http://tempuri.org/IDataProvider/AlterSummaryDbExceptionFault", Name="DbException", Namespace="http://schemas.datacontract.org/2004/07/CFAPService.Faults")]
        [System.ServiceModel.FaultContractAttribute(typeof(UnitTest.DataProviderService.DataNotValidException), Action="http://tempuri.org/IDataProvider/AlterSummaryDataNotValidExceptionFault", Name="DataNotValidException", Namespace="http://schemas.datacontract.org/2004/07/CFAPService.Faults")]
        [System.ServiceModel.FaultContractAttribute(typeof(UnitTest.DataProviderService.TryChangeReadOnlyFiledException), Action="http://tempuri.org/IDataProvider/AlterSummaryTryChangeReadOnlyFiledExceptionFault" +
            "", Name="TryChangeReadOnlyFiledException", Namespace="http://schemas.datacontract.org/2004/07/CFAPService.Faults")]
        [System.ServiceModel.TransactionFlowAttribute(System.ServiceModel.TransactionFlowOption.Allowed)]
        void AlterSummary(UnitTest.DataProviderService.Summary summary, UnitTest.DataProviderService.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDataProvider/AlterSummary", ReplyAction="http://tempuri.org/IDataProvider/AlterSummaryResponse")]
        System.Threading.Tasks.Task AlterSummaryAsync(UnitTest.DataProviderService.Summary summary, UnitTest.DataProviderService.User user);
    ...
    public partial class DataProviderClient : System.ServiceModel.ClientBase<UnitTest.DataProviderService.IDataProvider>, UnitTest.DataProviderService.IDataProvider {
        ...
        public void AlterSummary(UnitTest.DataProviderService.Summary summary, UnitTest.DataProviderService.User user) {
            base.Channel.AlterSummary(summary, user);
        }
        
        public System.Threading.Tasks.Task AlterSummaryAsync(UnitTest.DataProviderService.Summary summary, UnitTest.DataProviderService.User user) {
